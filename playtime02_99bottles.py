...
for bottles in range(99,0,-1): #start, stop, step
	if bottles == 1:
		print "{0} bottle{1} of beer on the wall, {0} bottle{1} of beer...\nAnd if that one bottle should happen to fall,".format(bottles, plural, bottles, plural)
	elif bottles != 1:
		plural = "s"
	...
	print "{0} bottle{1} of beer on the wall!".format(bottles, plural)
